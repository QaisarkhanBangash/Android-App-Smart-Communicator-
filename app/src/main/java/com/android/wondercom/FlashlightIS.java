 ...
 * helper methods.
 */
public class FlashlightIS extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        getApplicationContext().getPackageManager().hasSystemFeature(PackageManager.FEATURE_CAMERA_FLASH);
        {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(this,e.toString()+" its Flashlight on service",Toast.LENGTH_SHORT).show();
                }
                try {
        ...
        Toast.makeText(this,"FLASHLIGHT ON SERVICE STARTED",Toast.LENGTH_SHORT).show();
    }
